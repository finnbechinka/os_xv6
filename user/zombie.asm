...
main(void)
{
  ...
  if(fork() > 0)
   ...
   c:	318080e7          	jalr	792(ra) # 320 <fork>
  10:	00a04763          	bgtz	a0,1e <main+0x1e>
    sleep(5);  // Let child exit before parent.
  exit(0);
  14:	4501                	li	a0,0
  16:	00000097          	auipc	ra,0x0
  1a:	312080e7          	jalr	786(ra) # 328 <exit>
    sleep(5);  // Let child exit before parent.
  1e:	4515                	li	a0,5
  20:	00000097          	auipc	ra,0x0
  24:	398080e7          	jalr	920(ra) # 3b8 <sleep>
...
000000000000009c <strsub>:
int strsub(const char *s, const char *sub){
  9c:	7139                	addi	sp,sp,-64
  9e:	fc06                	sd	ra,56(sp)
  a0:	f822                	sd	s0,48(sp)
  a2:	f426                	sd	s1,40(sp)
  a4:	f04a                	sd	s2,32(sp)
  ...
  a8:	e852                	sd	s4,16(sp)
  aa:	e456                	sd	s5,8(sp)
  ac:	0080                	addi	s0,sp,64
  ae:	8a2a                	mv	s4,a0
  b0:	89ae                	mv	s3,a1
  for(i = 0; i < strlen(s); i++){
  b2:	84aa                	mv	s1,a0
  b4:	4901                	li	s2,0
  b6:	a019                	j	bc <strsub+0x20>
  b8:	2905                	addiw	s2,s2,1
  ba:	0485                	addi	s1,s1,1
  bc:	8552                	mv	a0,s4
  be:	00000097          	auipc	ra,0x0
  c2:	fb4080e7          	jalr	-76(ra) # 72 <strlen>
  c6:	2501                	sext.w	a0,a0
  c8:	04a97863          	bgeu	s2,a0,118 <strsub+0x7c>
    if(s[i] == sub[0]){
  cc:	8aa6                	mv	s5,s1
  ce:	0004c703          	lbu	a4,0(s1)
  d2:	0009c783          	lbu	a5,0(s3)
  d6:	fef711e3          	bne	a4,a5,b8 <strsub+0x1c>
      for(j = 1; j < strlen(sub); j++){
  da:	854e                	mv	a0,s3
  dc:	00000097          	auipc	ra,0x0
  e0:	f96080e7          	jalr	-106(ra) # 72 <strlen>
  e4:	0005059b          	sext.w	a1,a0
  e8:	ffe5061b          	addiw	a2,a0,-2
  ec:	1602                	slli	a2,a2,0x20
  ee:	9201                	srli	a2,a2,0x20
  f0:	0609                	addi	a2,a2,2
  f2:	4785                	li	a5,1
  f4:	0007871b          	sext.w	a4,a5
  f8:	fcb770e3          	bgeu	a4,a1,b8 <strsub+0x1c>
        if(s[j+i] != sub[j]){
  fc:	00fa86b3          	add	a3,s5,a5
 100:	00f98733          	add	a4,s3,a5
 104:	0006c683          	lbu	a3,0(a3)
 108:	00074703          	lbu	a4,0(a4)
 10c:	fae696e3          	bne	a3,a4,b8 <strsub+0x1c>
        if(j == strlen(sub) -1){
 110:	0785                	addi	a5,a5,1
 112:	fec791e3          	bne	a5,a2,f4 <strsub+0x58>
 116:	a011                	j	11a <strsub+0x7e>
  return -1;
 118:	597d                	li	s2,-1
}
 11a:	854a                	mv	a0,s2
 11c:	70e2                	ld	ra,56(sp)
 11e:	7442                	ld	s0,48(sp)
 120:	74a2                	ld	s1,40(sp)
 122:	7902                	ld	s2,32(sp)
 124:	69e2                	ld	s3,24(sp)
 126:	6a42                	ld	s4,16(sp)
 128:	6aa2                	ld	s5,8(sp)
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d0:	37cc8c93          	addi	s9,s9,892 # 848 <malloc+0xee>
 ...
 4de:	3c6b8b93          	addi	s7,s7,966 # 8a0 <digits>
 ...
 604:	24098993          	addi	s3,s3,576 # 840 <malloc+0xe6>
        while(*s != 0){
 608:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 6e6:	1d67b783          	ld	a5,470(a5) # 8b8 <freep>
 ...
 70e:	00e6ea63          	bltu	a3,a4,722 <free+0x4a>
{
 ...
 750:	16f73623          	sd	a5,364(a4) # 8b8 <freep>
}
 754:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 782:	13a53503          	ld	a0,314(a0) # 8b8 <freep>
 ...
 7aa:	11290913          	addi	s2,s2,274 # 8b8 <freep>
  if(p == (char*)-1)
 7ae:	5afd                	li	s5,-1
 7b0:	a895                	j	824 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7b2:	00000797          	auipc	a5,0x0
 7b6:	10e78793          	addi	a5,a5,270 # 8c0 <base>
 7ba:	00000717          	auipc	a4,0x0
 7be:	0ef73f23          	sd	a5,254(a4) # 8b8 <freep>
 7c2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7e6:	0ca73b23          	sd	a0,214(a4) # 8b8 <freep>
      return (void*)(p + 1);
 ...
 834:	b80080e7          	jalr	-1152(ra) # 3b0 <sbrk>
  if(p == (char*)-1)
