...
main(int argc, char *argv[])
{
  ...
  1e:	690080e7          	jalr	1680(ra) # 6aa <fprintf>
    exit(1);
  22:	4505                	li	a0,1
  ...
  36:	38c080e7          	jalr	908(ra) # 3be <link>
  3a:	00054763          	bltz	a0,48 <main+0x48>
    fprintf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit(0);
  3e:	4501                	li	a0,0
  40:	00000097          	auipc	ra,0x0
  44:	31e080e7          	jalr	798(ra) # 35e <exit>
    fprintf(2, "link %s %s: failed\n", argv[1], argv[2]);
  48:	6894                	ld	a3,16(s1)
  4a:	6490                	ld	a2,8(s1)
...
int strsub(const char *s, const char *sub){
  ...
  e8:	84aa                	mv	s1,a0
  ea:	4901                	li	s2,0
  ec:	a019                	j	f2 <strsub+0x20>
  ee:	2905                	addiw	s2,s2,1
  f0:	0485                	addi	s1,s1,1
  f2:	8552                	mv	a0,s4
  f4:	00000097          	auipc	ra,0x0
  f8:	fb4080e7          	jalr	-76(ra) # a8 <strlen>
  fc:	2501                	sext.w	a0,a0
  fe:	04a97863          	bgeu	s2,a0,14e <strsub+0x7c>
    if(s[i] == sub[0]){
 102:	8aa6                	mv	s5,s1
 104:	0004c703          	lbu	a4,0(s1)
 108:	0009c783          	lbu	a5,0(s3)
 10c:	fef711e3          	bne	a4,a5,ee <strsub+0x1c>
      for(j = 1; j < strlen(sub); j++){
 110:	854e                	mv	a0,s3
 112:	00000097          	auipc	ra,0x0
 116:	f96080e7          	jalr	-106(ra) # a8 <strlen>
 11a:	0005059b          	sext.w	a1,a0
 11e:	ffe5061b          	addiw	a2,a0,-2
 122:	1602                	slli	a2,a2,0x20
 124:	9201                	srli	a2,a2,0x20
 126:	0609                	addi	a2,a2,2
 128:	4785                	li	a5,1
 12a:	0007871b          	sext.w	a4,a5
 12e:	fcb770e3          	bgeu	a4,a1,ee <strsub+0x1c>
        if(s[j+i] != sub[j]){
 132:	00fa86b3          	add	a3,s5,a5
 136:	00f98733          	add	a4,s3,a5
 13a:	0006c683          	lbu	a3,0(a3)
 13e:	00074703          	lbu	a4,0(a4)
 142:	fae696e3          	bne	a3,a4,ee <strsub+0x1c>
        if(j == strlen(sub) -1){
 146:	0785                	addi	a5,a5,1
 148:	fec791e3          	bne	a5,a2,12a <strsub+0x58>
 14c:	a011                	j	150 <strsub+0x7e>
  return -1;
 14e:	597d                	li	s2,-1
}
 150:	854a                	mv	a0,s2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 446:	4c650513          	addi	a0,a0,1222 # 908 <digits>
 44a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 506:	3aec8c93          	addi	s9,s9,942 # 8b0 <malloc+0x120>
 ...
 63a:	27298993          	addi	s3,s3,626 # 8a8 <malloc+0x118>
        while(*s != 0){
 63e:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 71c:	2087b783          	ld	a5,520(a5) # 920 <freep>
 ...
 744:	00e6ea63          	bltu	a3,a4,758 <free+0x4a>
{
 ...
 786:	18f73f23          	sd	a5,414(a4) # 920 <freep>
}
 78a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7b8:	16c53503          	ld	a0,364(a0) # 920 <freep>
 ...
 7e0:	14490913          	addi	s2,s2,324 # 920 <freep>
  if(p == (char*)-1)
 7e4:	5afd                	li	s5,-1
 7e6:	a895                	j	85a <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7e8:	00000797          	auipc	a5,0x0
 7ec:	14078793          	addi	a5,a5,320 # 928 <base>
 7f0:	00000717          	auipc	a4,0x0
 7f4:	12f73823          	sd	a5,304(a4) # 920 <freep>
 7f8:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 81c:	10a73423          	sd	a0,264(a4) # 920 <freep>
      return (void*)(p + 1);
